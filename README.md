...
```javascript
image = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-img-locomotion-house-cat@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-img-locomotion-house-cat@v0.1.1-umd/browser.js"></script>
```
